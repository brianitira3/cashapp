...
const videoData: Video[] = [
  {
    ...
    thumbnail:
      "https://cdn.create.vista.com/downloads/3d8b32e5-d62e-4f1b-9a8a-910ce354a40f_1024.jpeg",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-gray-100 p-10">
      <div className="container mx-auto">
        <header className="text-center mb-16 flex flex-col items-center space-y-4">
          ...
          {/* Sign Out Button */}
          <SignOutButton>
            <button className="bg-red-500 text-white px-4 py-2 rounded-full hover:shadow-lg transition-all">
              Sign Out
            </button>
          </SignOutButton>
        </header>
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {videoData.map((video) => (
            <VideoCard key={video.id} video={video} onWatchClick={handleWatchClick} />
          ))}
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                "This platform is amazing! I've earned $200 in just a month!"
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <Smile size={40} className="text-yellow-500 mb-4" />
              <p className="text-gray-600">
                "A great way to monetize my free time. Highly recommended!"
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <Smile size={40} className="text-yellow-500 mb-4" />
              <p className="text-gray-600">
                "Simple, effective, and fun. Love the idea!"
              </p>
        ...
        <footer className="text-center mt-20 text-gray-500">
          <p className="text-sm font-medium">
            Developed by <span className="text-blue-600 hover:underline">Brian Itira</span> | ©
            2024 Kenya Cash Generator
          </p>
